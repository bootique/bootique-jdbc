 ...
 * under the License.
 */
package io.bootique.jdbc.junit.derby;
...
@BQTest
public class DerbyTester_Liquibase_RelativeIT extends BaseDerbyTesterTest {

    @BQTestTool
    static final DerbyTester db = DerbyTester
            .db()
            .initDBWithLiquibaseChangelog("classpath:io/bootique/jdbc/junit/derby/DerbyTester_Liquibase_RelativeIT-changelog.yml");
