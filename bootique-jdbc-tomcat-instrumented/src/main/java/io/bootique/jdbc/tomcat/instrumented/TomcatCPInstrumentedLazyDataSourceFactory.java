...
public class TomcatCPInstrumentedLazyDataSourceFactory extends TomcatCPLazyDataSourceFactory {

    private MetricRegistry metricRegistry;

    public TomcatCPInstrumentedLazyDataSourceFactory(Map<String, TomcatCPDataSourceFactory> configs,
