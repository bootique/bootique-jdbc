...
package io.bootique.jdbc.junit.derby.dataset;
...
public class CsvDataSetBuilderIT {
    ...
    public void load_Empty() {
        T1.csvDataSet().load("classpath:io/bootique/jdbc/junit/derby/dataset/empty.csv").persist();
        T1.matcher().assertNoMatches();
    }

    @Test
    public void csvDataSet_Load() {
        T1.csvDataSet().load("classpath:io/bootique/jdbc/junit/derby/dataset/t1.csv").persist();
    ...
    public void csvDataSet_Load_Nulls_Dates() {
        T2.csvDataSet().load("classpath:io/bootique/jdbc/junit/derby/dataset/t2.csv").persist();
    ...
    public void csvDataSet_Load_Binary() {
        T3.csvDataSet().load("classpath:io/bootique/jdbc/junit/derby/dataset/t3.csv").persist();
    ...
    public void csvDataSet_Load_Boolean() {
        T4.csvDataSet().load("classpath:io/bootique/jdbc/junit/derby/dataset/t4.csv").persist();
