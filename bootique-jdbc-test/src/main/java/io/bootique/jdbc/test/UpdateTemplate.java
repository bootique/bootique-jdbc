...
class UpdateTemplate {
    ...
    public UpdateTemplate(DBManager parent) {
        this.parent = parent;
    }
    ...
    int execute(String sql, Collection<Object> bindings, Collection<Integer> bindingTypes) {
        try {
            return executeWithExceptions(sql, bindings, bindingTypes);
        } catch (SQLException e) {
            throw new RuntimeException("Error running SQL: " + sql, e);
        }
    }

    int executeWithExceptions(String sql, Collection<Object> bindings, Collection<Integer> bindingTypes) throws SQLException {
        Logger.log(sql);
