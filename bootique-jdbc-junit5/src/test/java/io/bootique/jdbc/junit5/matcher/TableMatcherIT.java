...
public class TableMatcherIT {
    ...
    public void testAssertMatchesCsv() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit5/matcher/t1_ref.csv", "c1");
    }
    ...
    public void testAssertMatchesCsv_Dates() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit5/matcher/t2_ref.csv", "c1");
    }
    ...
    public void testAssertMatchesCsv_Binary() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit5/matcher/t3_ref.csv", "c1");
    }
    ...
    public void testAssertMatchesCsv_Bigint() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit5/matcher/t4_ref.csv", "c1");
    }
