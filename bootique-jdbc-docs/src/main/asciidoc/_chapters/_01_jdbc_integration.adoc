...
Out of the box Bootique supports https://github.com/brettwooldridge/HikariCP[HikariCP connection pool provider]:
.Maven
[%collapsible%open]
====
[source,xml]
...
Alternatively you may include an <<jdbc-merics-and-healthchecks,"instrumented" version>> of this module, that will
