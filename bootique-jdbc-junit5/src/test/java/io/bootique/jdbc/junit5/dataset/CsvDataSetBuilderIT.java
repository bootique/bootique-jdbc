...
public class CsvDataSetBuilderIT {
    ...
    public void testLoad_Empty() {
        T1.csvDataSet().load("classpath:io/bootique/jdbc/junit5/dataset/empty.csv").persist();
        T1.matcher().assertNoMatches();
    }

    @Test
    public void testCsvDataSet_Load() {
        T1.csvDataSet().load("classpath:io/bootique/jdbc/junit5/dataset/t1.csv").persist();
    ...
    public void testCsvDataSet_Load_Nulls_Dates() {
        T2.csvDataSet().load("classpath:io/bootique/jdbc/junit5/dataset/t2.csv").persist();
    ...
    public void testCsvDataSet_Load_Binary() {
        T3.csvDataSet().load("classpath:io/bootique/jdbc/junit5/dataset/t3.csv").persist();
    ...
    public void testCsvDataSet_Load_Boolean() {
        T4.csvDataSet().load("classpath:io/bootique/jdbc/junit5/dataset/t4.csv").persist();
