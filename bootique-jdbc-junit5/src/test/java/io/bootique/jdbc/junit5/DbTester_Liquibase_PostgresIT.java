...
@BQTest
public class DbTester_Liquibase_PostgresIT extends BaseJdbcTesterTest {

    @RegisterExtension
    static final DbTester db = DbTester
            .testcontainersDb("jdbc:tc:postgresql:11:///")
            .runLiquibaseMigrations("classpath:io/bootique/jdbc/junit5/DbTester_Liquibase_PostgresIT-changelog.yml");

    @BQApp(skipRun = true)
    static final BQRuntime app = createRuntime(db);
