...
package io.bootique.jdbc.junit.derby.matcher;
...
public class CsvTableMatcherIT {
    ...
    public void assertMatchesCsv() {
        ...
        new CsvTableMatcher(T1).keyColumns("c1").assertMatches("classpath:io/bootique/jdbc/junit/derby/matcher/t1_ref.csv");
    }
    ...
    public void assertMatchesCsv_EmptyAsNulls() {
        ...
        new CsvTableMatcher(T1)
                .keyColumns("c1")
                .emptyStringIsNull()
                .assertMatches("classpath:io/bootique/jdbc/junit/derby/matcher/t1_ref.csv");
    }
    ...
    public void assertMatchesCsv_Dates() {
        ...
        new CsvTableMatcher(T2).keyColumns("c1").assertMatches("classpath:io/bootique/jdbc/junit/derby/matcher/t2_ref.csv");
    }
    ...
    public void assertMatchesCsv_Binary() {
        ...
        new CsvTableMatcher(T3).keyColumns("c1").assertMatches("classpath:io/bootique/jdbc/junit/derby/matcher/t3_ref.csv");
    }
    ...
    public void assertMatchesCsv_Numbers() {
        ...
        new CsvTableMatcher(T4).keyColumns("c1").assertMatches("classpath:io/bootique/jdbc/junit/derby/matcher/t4_ref.csv");
    }
}
