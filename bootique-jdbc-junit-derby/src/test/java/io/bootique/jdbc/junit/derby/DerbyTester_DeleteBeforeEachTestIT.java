...
@BQTest
public class DerbyTester_DeleteBeforeEachTestIT extends BaseDerbyTesterTest {

    @BQTestTool
    static final DerbyTester db = DerbyTester
            .db()
            .initDB("classpath:io/bootique/jdbc/junit/derby/DerbyTester_DeleteBeforeEachTestIT.sql")
