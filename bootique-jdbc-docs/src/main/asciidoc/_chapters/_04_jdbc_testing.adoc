...
<dependency>
    ...
    <artifactId>bootique-jdbc-junit-derby</artifactId>
    <scope>test</scope>
</dependency>
----
====
...
----
{
  testImplementation: 'io.bootique.jdbc:bootique-jdbc-junit-derby'
}
----
====
...
<dependency>
    <groupId>io.bootique.jdbc</groupId>
    <artifactId>bootique-jdbc-junit-testcontainers</artifactId>
    <scope>test</scope>
</dependency>
...
----
{
   testImplementation: 'io.bootique.jdbc:bootique-jdbc-junit-testcontainers'
