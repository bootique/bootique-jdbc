...
public class TomcatCPInstrumentedModuleIT {
    ...
    public void testPartialConfigsExcluded() {
        ...
        assertEquals(new HashSet<>(Arrays.asList("ds1", "ds2")), names);
    }
    ...
    public void testPartialConfigsExcluded_Vars() {
        ...
        Set<String> names = new HashSet<>(factory.allNames());
        assertEquals(new HashSet<>(Arrays.asList("ds1", "ds2", "FULLDSVARS")), names);
    }
}
