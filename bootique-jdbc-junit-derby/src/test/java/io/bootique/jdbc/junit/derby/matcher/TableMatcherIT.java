...
public class TableMatcherIT {
    ...
    public void assertMatchesCsv() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit/derby/matcher/t1_ref.csv", "c1");
    }
    ...
    public void assertMatchesCsv_Dates() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit/derby/matcher/t2_ref.csv", "c1");
    }
    ...
    public void assertMatchesCsv_Binary() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit/derby/matcher/t3_ref.csv", "c1");
    }
    ...
    public void assertMatchesCsv_Numbers() {
        ...
        matcher.assertMatchesCsv("classpath:io/bootique/jdbc/junit/derby/matcher/t4_ref.csv", "c1");
    }
